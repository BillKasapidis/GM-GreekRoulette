...
//Keyboard Movement
if (obj_game.player1controls == "keyboard"){
    ...
    obj_player1cross.x = mouse_x;
    obj_player1cross.y = mouse_y;
    image_angle = point_direction(x, y, obj_player1cross.x, obj_player1cross.y);
}else{
    //Gamepad controls
    ...
    obj_player1cross.x += haxis * 10;
    obj_player1cross.y += vaxis * 10;    
